.. _multicore_idle_exmif_test:

Multicore idle EXMIF test
#########################
...
It uses a system timer as a wake-up source and periodically sends a message using EXMIF.
...
.. |test path| replace:: :file:`tests/benchmarks/multicore/idle_exmif`
...
nRF5340 DK
  ...
  .. code-block:: console
     ...
     west build -p -b nrf5340dk/nrf5340/cpuapp -T benchmarks.multicore.idle_exmif.nrf5340dk_cpuapp_cpunet .
...
nRF54H20 DK
  ...
  .. code-block:: console
     ...
     west build -p -b nrf54h20dk/nrf54h20/cpuapp -T benchmarks.multicore.idle_exmif.nrf54h20dk_cpuapp_cpurad .

  You can build the test for application and PPR cores as follows:

  .. code-block:: console

     west build -p -b nrf54h20dk/nrf54h20/cpuapp -T benchmarks.multicore.idle_exmif.nrf54h20dk_cpuapp_cpuppr .
  ...
  .. code-block:: console
     ...
     west build -p -b nrf54h20dk/nrf54h20/cpuapp -T benchmarks.multicore.idle_exmif.nrf54h20dk_cpuapp_cpuppr_xip .
...
#. Observe the console output for both cores:
   ...
   * For the application core, the output should be as follows:
     ...
     .. code-block:: console
       ...
       *** Booting nRF Connect SDK zephyr-v3.5.0-3517-g9458a1aaf744 ***
       Multi-core idle_exmif test on nrf5340dk/nrf5340/cpuapp
       Multi-core idle_exmif test iteration 0
       Multi-core idle_exmif test iteration 1
       ...
   ...
   * For the remote core, the output should be as follows:
     ...
     .. code-block:: console
        ...
        *** Booting nRF Connect SDK zephyr-v3.5.0-3517-g9458a1aaf744 ***
        Multi-core idle_exmif test on nrf5340dk/nrf5340/cpunet
        Multi-core idle_exmif test iteration 0
        Multi-core idle_exmif test iteration 1
        ...
